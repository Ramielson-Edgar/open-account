document.querySelectorAll(".account-currency__selected").forEach((o) => {
  o.addEventListener("click", () => {
    ...
    parent.querySelector('.account-currency__options-container').classList.toggle("active");
  });
});

document.querySelectorAll(".account-currency__option").forEach((o) => {
  o.addEventListener("click", () => {
    let parent = o.closest(".account-currency__options-container").closest('.account-currency__select-box');
...
function f() {
  document.querySelectorAll(".account-currency__options-container").forEach(a => {
